...
Netplay builds | | [Stable](https://github.com/mavethee/xenia-canary-no-avx-check/releases/tag/v5.0.0) ◦ [Latest](https://github.com/mavethee/xenia-canary-no-avx-check/actions?query=branch%3Anetplay_canary_experimental)
